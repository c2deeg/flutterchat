...
class QuickInfoTile extends StatefulWidget {
  ...
  @override
  QuickInfoTileState createState() => QuickInfoTileState();
}

class QuickInfoTileState extends State<QuickInfoTile>
  ...
  Widget build(BuildContext context) {
    ...
    _headerColor?.end = theme.colorScheme.secondary;
    _iconColor?.begin = theme.unselectedWidgetColor;
    _iconColor?.end = theme.colorScheme.secondary;
