...
void showNoMatchingPassword(BuildContext context) {
  const snackBar = SnackBar(
...
void showWrongOldPassword(BuildContext context) {
  const snackBar = SnackBar(
...
void noScan() => Fluttertoast.showToast(
    msg: 'Please scan a document', gravity: ToastGravity.SNACKBAR);
...
void passwordChanged() => Fluttertoast.showToast(
...
pressExit() => Fluttertoast.showToast(
      // backgroundColor: Palette.red,
