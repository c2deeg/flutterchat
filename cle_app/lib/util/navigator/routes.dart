class Routes {
  ...
  //settings
  static const String personalSettingsPage = '/settings/personal';
  static const String notificationSettingsPage = '/settings/notifications';
  static const String passwordSettingsPage = '/settings/security';
  static const String legalSettingsPage = '/settings/help&legal';
